...
export class TemperatureReadingComponent implements OnInit {
  ...
  centigrade = new FormControl('', Validators.required);
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: 'org.acme.shipping.externalchain.TemperatureReading',
      'centigrade': this.centigrade.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.centigrade) {
        formObject.centigrade = result.centigrade;
      } else {
        formObject.centigrade = null;
      }
