...
@Component({
  selector: 'app-solicitarpedidoproveedor',
  templateUrl: './SolicitarPedidoProveedor.component.html',
  styleUrls: ['./SolicitarPedidoProveedor.component.css'],
  providers: [SolicitarPedidoProveedorService]
})
export class SolicitarPedidoProveedorComponent implements OnInit {
  ...
  constructor(private serviceSolicitarPedidoProveedor: SolicitarPedidoProveedorService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceSolicitarPedidoProveedor.getAll()
    .toPromise()
    .then((result) => {
  ...
  addTransaction(form: any): Promise<any> {
    ...
    return this.serviceSolicitarPedidoProveedor.addTransaction(this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
  ...
  updateTransaction(form: any): Promise<any> {
    ...
    return this.serviceSolicitarPedidoProveedor.updateTransaction(form.get('transactionId').value, this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceSolicitarPedidoProveedor.deleteTransaction(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceSolicitarPedidoProveedor.getTransaction(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
